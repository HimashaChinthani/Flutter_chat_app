...
class NotificationService {
  ...
  static Stream<QuerySnapshot> streamNotificationsFor(String uid) {
    return _notificationsRef.where('toUid', isEqualTo: uid).snapshots();
  }
  ...
  static Future<void> markUnread(String docId) async {
    await _notificationsRef.doc(docId).update({'read': false});
  }
  ...
  static Future<void> markAllUnreadFor(String uid) async {
    final readDocs = await _notificationsRef
        .where('toUid', isEqualTo: uid)
