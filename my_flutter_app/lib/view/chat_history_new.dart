...
class _ChatHistoryScreenState extends State<ChatHistoryScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'Are you sure you want to delete this chat session? This will delete the chat for both users and cannot be undone.',
          ),
          actions: [
            TextButton(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Chat session deleted for both users'),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        // Navigate to welcome screen when back button is pressed
                ...
                leading: IconButton(
                  ...
                  onPressed: () {
                    if (widget.onBackToHome != null) {
                      ...
                      // Navigate to welcome screen when custom back button is pressed
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
